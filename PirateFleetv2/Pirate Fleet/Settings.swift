...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "Oh no! You've hit a sea monster! The computer has an advantage"
        static let ComputerHitMonster = "Yay! The computer has hit a sea monster! You'll be rewarded"
